...
int main( void ) {
	...
	char cmdFeval[] = "/p/pies/Monticello/PIES_14Sep06_nt_copy_7feb08/Compile_17dec08/piesDec171132_portal t >& t.log";
	...
	msg( "NOTE THAT CMDFEVAL IS HARD-CODED AS \"%s\" PLUS A BUNCH OF RM COMMANDS.", cmdFeval );
	//
	//
	//
	{
