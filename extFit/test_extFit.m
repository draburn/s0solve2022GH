	...
	msg( thisFile, __LINE__, sprintf( "bigX_secret = %g.", bigX_secret ) );
	msg( thisFile, __LINE__, sprintf( "bigX = %g.", bigX ) );
	msg( thisFile, __LINE__, sprintf( "res bigX = %g.", abs(bigX-bigX_secret) ) );
	return;
