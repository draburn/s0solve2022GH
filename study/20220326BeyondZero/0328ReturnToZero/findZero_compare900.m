...
semilogy( ...
  datOut_800.fevalCountVals, datOut_800.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2, ...
  datOut_900.fevalCountVals, datOut_900.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2, ...
  datOut_940.fevalCountVals, datOut_940.fNormVals+eps, '*-', 'markersize', 20, 'linewidth', 2, ...
  datOut_940x200.fevalCountVals, datOut_940x200.fNormVals+eps, 'p-', 'markersize', 20, 'linewidth', 2, ...
  datOut_904.fevalCountVals, datOut_904.fNormVals+eps, 'o-', 'markersize', 20, 'linewidth', 2, ...
  ...
  datOut_444x.fevalCountVals, datOut_444x.fNormVals+eps, '^-', 'markersize', 20, 'linewidth', 2    );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
numFigs++; figure( numFigs );
semilogy( ...
  datOut_800.iterCountVals, datOut_800.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2, ...
  datOut_900.iterCountVals, datOut_900.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2, ...
  datOut_940.iterCountVals, datOut_940.fNormVals+eps, '*-', 'markersize', 20, 'linewidth', 2, ...
  datOut_940x200.iterCountVals, datOut_940x200.fNormVals+eps, 'p-', 'markersize', 20, 'linewidth', 2, ...
  datOut_904.iterCountVals, datOut_904.fNormVals+eps, 'o-', 'markersize', 20, 'linewidth', 2, ...
