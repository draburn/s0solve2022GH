% Dev
% The quintessential solver:
%  full Jacobian every iteration, to second order, plus minscan of Levenberg curve.

function [ vecXF, vecFF, datOut ] = findZero_000( vecX0, funchF, prm=[] )
	time0 = time();
	fevalCount = 0;
	setVerbLevs;
