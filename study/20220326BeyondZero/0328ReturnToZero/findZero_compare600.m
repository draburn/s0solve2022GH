...
semilogy( ...
  ...
  datOut_600.fevalCountVals, datOut_600.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2   );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
...
semilogy( ...
  ...
  datOut_600.iterCountVals, datOut_600.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2 );
grid on;
ylabel( "||f||" );
