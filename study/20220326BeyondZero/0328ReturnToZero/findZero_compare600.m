...
semilogy( ...
  ...
  datOut_700.fevalCountVals, datOut_700.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2   );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
...
semilogy( ...
  ...
  datOut_700.iterCountVals, datOut_700.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2 );
grid on;
ylabel( "||f||" );
