...
semilogy( ...
  ...
  datOut_825.fevalCountVals, datOut_825.fNormVals+eps, 'o-', 'markersize', 20, 'linewidth', 2    );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
...
semilogy( ...
  ...
  datOut_825.iterCountVals, datOut_825.fNormVals+eps, 'o-', 'markersize', 20, 'linewidth', 2 );
grid on;
ylabel( "||f||" );
