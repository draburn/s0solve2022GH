...
timeSS = time();
[ vecXF_800x, vecFF_800x, datOut_800x ] = findZero_800( vecX0, funchF, prm );
...
msg( __FILE__, __LINE__, sprintf( "  %15s:  %11.3e;  %11d;  %11d;  %11.3e.", "800x", norm(vecFF_800x), datOut_800x.iterCount, datOut_800x.fevalCount, time_800x ) );
...
semilogy( ...
  ...
  datOut_800x.fevalCountVals, datOut_800x.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2, ...
  datOut_550.fevalCountVals, datOut_550.fNormVals+eps, 's-', 'markersize', 20, 'linewidth', 2, ...
...
semilogy( ...
  ...
  datOut_800x.iterCountVals, datOut_800x.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2, ...
  datOut_550.iterCountVals, datOut_550.fNormVals+eps, 's-', 'markersize', 20, 'linewidth', 2, ...
