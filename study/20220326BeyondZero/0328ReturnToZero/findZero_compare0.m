...
semilogy( ...
  ...
  datOut_090.fevalCountVals, datOut_090.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2  );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
...
semilogy( ...
  ...
  datOut_090.iterCountVals, datOut_090.fNormVals+eps, 'x-', 'markersize', 20, 'linewidth', 2 );
grid on;
ylabel( "||f||" );
