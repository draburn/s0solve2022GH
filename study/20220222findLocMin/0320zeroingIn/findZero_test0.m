	...
	semilogy( ...
	  ...
	  datOut_mimic.fevalCountVals, datOut_mimic.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2 );
	grid on;
	ylabel( "||f||" );
	xlabel( "feval count" );
	%
	...
	semilogy( ...
	  ...
	  datOut_mimic.iterCountVals, datOut_mimic.fNormVals+eps, '+-', 'markersize', 20, 'linewidth', 2 );
	grid on;
	ylabel( "||f||" );
