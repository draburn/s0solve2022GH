...
plot( ...
  ...
  gVals(gVals>0), omegaVals(gVals>0), '*', 'linewidth', 3, 'markersize', 20, ...
...
plot( ...
  ...
  gVals(gVals>0), fVals(gVals>0), '*', 'linewidth', 3, 'markersize', 20, ...
...
plot( ...
  ...
  gVals(gVals>gC), (1:numVals)(gVals>gC), '*', 'linewidth', 3, 'markersize', 20 );
grid on;
%
return;
