...
function [ vecXF, vecFF, datOut ] = findZero_800insensed2( vecX0, funchF, prm=[] )
	time0 = time();
	fevalCount = 0;
	%setVerbLevs;
	mydefs;
	...
	[ vecSSDeltaN, linsolf_datOut ] = insensedlinsolf( funchMatJProd, -vecF, zeros(sizeX,1), linsolf_prm );
