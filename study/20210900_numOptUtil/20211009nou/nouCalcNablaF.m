function [ matNablaF, retCode, datOut ] = nouCalcNablaF( funchF, vecX0, prm=[] )
	%
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% COMMON INIT.
	%
	commondefs;
	thisFile = "nouCalcNablaF";
...
%!		%
%!		prm = [];
%!		matNablaF = nouCalcNablaF( funchF, vecX0, prm );
