function [ funchFG, vecX0, solverPrm, datOut ] = z__init20250501( initPrm=[] )
	% DRaburn 2025-05-01:
	%  This (z__init20250501.m) is copied from z__init0125danmoqnjpy.m,
	%  with some modification for experimentation.
	datOut = [];
