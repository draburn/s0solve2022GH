	...
	%
	vecDeltaN = levsol0110( f0, vecG, matH, vecS );
	...
	%
	vecDeltaNP = levsol0110( f0, vecG, matH, vecS, bN+0.01 );
	vecDeltaN0 = levsol0110( f0, vecG, matH, vecS, bN );
	vecDeltaNM = levsol0110( f0, vecG, matH, vecS, bN-0.01 );
	mat_nearEnd = [ vecDeltaN, vecDeltaNP, vecDeltaN0, vecDeltaNM ]
	%
	vecDelta06 = levsol0110( f0, vecG, matH, vecS, bN*0.6 );
	vecDelta05 = levsol0110( f0, vecG, matH, vecS, bN*0.5 );
	vecDelta04 = levsol0110( f0, vecG, matH, vecS, bN*0.4 );
	mat_nearMid = [ vecDelta06, vecDelta05, vecDelta04 ]
	%
	vecDelta002 = levsol0110( f0, vecG, matH, vecS, bN*0.02 );
	vecDelta001 = levsol0110( f0, vecG, matH, vecS, bN*0.01 );
	vecDelta000 = levsol0110( f0, vecG, matH, vecS, bN*0.00 );
	mat_nearZer = [ vecDelta002, vecDelta001, vecDelta000 ]
	%
	bMax = []
	xMax = []
	vecDelta = levsol0110( f0, vecG, matH, vecS, bMax, xMax );
