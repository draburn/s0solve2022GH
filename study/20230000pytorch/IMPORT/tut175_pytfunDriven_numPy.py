...
for epoch in range(2):  # loop over the dataset multiple times
    ...
    for i, data in enumerate(trainloader, 0):
        ...
        if (do_grad_init):
            ...
            sxsolve_gradmom = sxsolve_gradloc.copy()
            do_grad_init = False
        else:
            sxsolve_gradmom = sxsolve_momentum*sxsolve_gradmom + (1.0-sxsolve_momentum)*sxsolve_gradloc
        
        # TAKE STEP
        #optimizer.step()
        sxsolve_x -= sxsolve_lr*sxsolve_gradmom
