...
semilogy( ...
  ...
  datOut_444.fevalCountVals, datOut_444.fNormVals+eps, 's-', 'markersize', 20, 'linewidth', 2   );
grid on;
ylabel( "||f||" );
xlabel( "feval count" );
%
...
semilogy( ...
  ...
  datOut_444.iterCountVals, datOut_444.fNormVals+eps, 's-', 'markersize', 20, 'linewidth', 2 );
grid on;
ylabel( "||f||" );
