...
% 2022-08-30: Replacing insensedlinsolf() with insensedlinsolf_noSJA().

function [ vecXF, vecFF, datOut ] = findZero_800ins_noSJA( vecX0, funchF, prm=[] )
	time0 = time();
	fevalCount = 0;
	%setVerbLevs;
	mydefs;
	...
	[ vecSSDeltaN, linsolf_datOut ] = insensedlinsolf_noSJA( funchMatJProd, -vecF, zeros(sizeX,1), linsolf_prm );
