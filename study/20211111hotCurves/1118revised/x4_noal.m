...
funchG = @(x)( testFunc_gForLSODE(x,testFuncPrm) );
%
tempPrm = [];
...
%%%matY_grad_old = NEO_calcLevCurve( testFuncPrm, vecX0 )';
%
tempPrm = [];
...
matY_grad_simple = NEO_calcGradCurve1128( funchG, vecX0 );
%
tempPrm = [];
%%%matY_grad1 = OLD_calcHOTGradCurve2Heun( testFuncPrm, vecX0 );
%%%matY_grad1 = calcHOTGradCurve2( funchOmegaG, vecX0 );
tic_calcLevCurve=tic();
matY_grad1 = NEO_calcLevCurve1128( funchG, vecX0 );
toc(tic_calcLevCurve);
%
