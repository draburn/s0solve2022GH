...
%zzz
msg( thisFile, __LINE__, "Hack! HACK!! HAA~AACK!!!!" );
msg( thisFile, __LINE__, "This is not 'simple', this is scaffolding!" );
msg( thisFile, __LINE__, "No, no.... This is 'simple'... WAY FORWARD!" );
%%%funchAntiG = @(x)( -testFunc_gForLSODE(x,testFuncPrm) );
%%%matY_grad_simple = NEO_calcGradCurve( funchAntiG, vecX0 );
matY_grad_simple = NEO_calcGradCurveX( testFuncPrm, vecX0 );
matY_grad_simple = matY_grad_simple';
%
tempPrm = [];
...
%zzz
msg( thisFile, __LINE__, "Hack! HACK!! HAA~AACK!!!!" );
msg( thisFile, __LINE__, "This is not 'grad1', this is... I don't even know what." );
matY_grad1 = NEO_calcLevCurve( testFuncPrm, vecX0 );
matY_grad1 = matY_grad1';
%
