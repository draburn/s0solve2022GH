function [ matX, datOut ] = calcGradCurve( funchOmega, funchG, vecX0, prm=[] )
	thisFile = "calcGradCurve";
	msg( thisFile, __LINE__, "THIS IS A WORK-IN-PROGRESS!" );
	thisFile = "calcMinfordCurve";
	msg( thisFile, __LINE__, "TO-DO..." );
	msg( thisFile, __LINE__, " - Allow scaling." );
	msg( thisFile, __LINE__, "Later..." );
	msg( thisFile, __LINE__, " ~ Take larger chunks, generate more points, a posteriori interpolation." );
	%
	targetStepSize = 0.2;
	stepsPerChunk = 20;
	gradNormTol = 1e-6;
