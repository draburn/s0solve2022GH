function matY = calcHOTLevCurve( modelFuncPrm, vecX0, prm=[] )
	thisFile = "calcHOTLevCurve";
	...
	while (1)
		...
		if ( 0 ~= cholFlag )
			msg( thisFile, __LINE__, "Hessian became non-positive-definite." );
			error( "Hessian became non-positive-definite." );
			return;
		end
