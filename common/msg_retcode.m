%  Function...
%    msg_retcode( verbLev, fileName, lineNum, retCode )
%  Overview...
...
function msg_retcode( verbLev, fileName, lineNum, retCode )
	commondefs;
	...
	if (showMsg)
		msg( fileName, lineNum, sprintf( ...
		  "Received retCode %s.", retcode2str(retCode) ) );
	end
return;
end
...
%!	msg_retcode( verbLev, thisFile, __LINE__, RETCODE__SUCCESS );
%!	msg_retcode( verbLev, thisFile, __LINE__, RETCODE__IMPOSED_STOP );
%!	msg_retcode( verbLev, thisFile, __LINE__, RETCODE__ALGORITHM_BREAKDOWN );
%!	msg_retcode( verbLev, thisFile, __LINE__, RETCODE__UNSPECIFIC_ERROR );
